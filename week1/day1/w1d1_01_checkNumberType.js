...
let numberToCheck = 5;
numberReturned = checkNumberType(numberToCheck);
console.log ("The number passed to check is " + numberReturned + " and the datatype of returned number is " + typeof(numberReturned) );